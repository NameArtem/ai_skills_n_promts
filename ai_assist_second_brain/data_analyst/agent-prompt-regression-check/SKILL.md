---
name: agent-prompt-regression-check
description: Review a change to an LLM agent's system prompt or instructions (given as a diff, or by comparing $ARGUMENTS to its previous version in git history) for likely behavior regressions.
---
