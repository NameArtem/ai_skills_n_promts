---
name: cultivar-analysis
description: Analyze model performance and data distribution broken down by a categorical grouping column (e.g., segment, cohort, region, product line, cultivar — whatever grouping variable exists in this dataset).
---
