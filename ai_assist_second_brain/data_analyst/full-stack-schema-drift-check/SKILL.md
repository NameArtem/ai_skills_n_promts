---
name: full-stack-schema-drift-check
description: Compare the backend API contract (e.g., FastAPI Pydantic models, DB schema) against the frontend's expectations (TypeScript types, API client, form fields) to catch drift before it breaks the UI.
---
