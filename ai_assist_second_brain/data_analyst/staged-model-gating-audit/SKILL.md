---
name: staged-model-gating-audit
description: Audit a multi-stage model pipeline (e.g., a classifier "gate" feeding a downstream regressor/severity model, or any staged decision → detail architecture) for boundary bugs.
---
