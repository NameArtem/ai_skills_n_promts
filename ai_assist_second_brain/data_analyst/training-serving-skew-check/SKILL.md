---
name: training-serving-skew-check
description: Compare feature computation logic between the training/eval pipeline and the serving/inference path (API, batch job, or scheduled pipeline) to catch train/serve skew.
---
