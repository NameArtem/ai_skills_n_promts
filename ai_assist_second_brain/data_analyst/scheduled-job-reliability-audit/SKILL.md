---
name: scheduled-job-reliability-audit
description: Audit a scheduled/cron-triggered pipeline (e.g., a weekly data pipeline, batch job, or cron-deployed service) for reliability gaps.
---
