---
name: multi-agent-routing-audit
description: Audit the routing/orchestration logic in this multi-agent pipeline (e.g., LangGraph, custom orchestrator, or similar agentic framework).
---
